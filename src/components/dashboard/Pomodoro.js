                ...
                <div className='PomodoroData'>
                    <div className='PomodoroSpan'>
                        <div className='Pomodoro-div m-3'>
                            ...
                            <h1 id='time' style={{ fontSize: 50 + 'px', marginTop: 30 + 'px' }}>
                    ...
                    <div className='PomodoroSpan'>
                        <h4 style={{ marginTop: 100 + 'px' }}>
                            The Pomodoro Method has been scientifically proven to improve productivity by allowing users
                            to regularly take breaks and relax their minds. It is encouraged to break down larger
                            projects and work on separate aspects each loop. Every 4th break is extended in order to
                            give the user a reward for hard work. <br />
                            It is recommended to ignore outside temptations while using the Pomodoro Method.
                        </h4>
                        <p>
                            Notice: It is recommended to keep this tab full screen in another window in order to keep
                            the timer moving while using other programs, other programs won't be able to be full screen.
                        </p>
                    </div>
                </div>
            </>
