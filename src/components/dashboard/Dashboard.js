                ...
                <div style={{}} className="container">
                    <div className="row Dashboard-Content">
                        ...
                        <div className=" col s12 m6">
                            <h5>
                                <p className="flow-text grey-text text-darken-1">
                                    ...
                                    attempting to devise a solution in order to help you too. In this alpha version of the program, we want to utilize
                                    the Pomodoro Method as the most important thing of the program.
                                </p>
                                <p className="flow-text grey-text text-darken-1">
                        ...
                        <div className="landing-copy col s12 m6">
                            <h5>
                                <p className="flow-text grey-text text-darken-1">
                                    The Pomodoro Method has been scientifically proven to improve productivity by allowing users to regularly take
                                    breaks and relax their minds. It is encouraged to break down larger projects and work on separate aspects each
                                    loop. Every 4th break is extended in order to give the user a reward for hard work. <br />
                                    It is recommended to ignore outside temptations while using the Pomodoro Method.
                                </p>
                                <p className="flow-text grey-text text-darken-1">
                                    Notice: It is recommended to keep this tab full screen in another window in order to keep the timer moving while
                                    using other programs, other programs won't be able to be full screen.
                                </p>
                            </h5>
